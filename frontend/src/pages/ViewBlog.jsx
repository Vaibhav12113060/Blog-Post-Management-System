...
const ViewBlog = () => {
  ...
  return (
    <div className="h-screen bg-[#CBD5E1] flex flex-col items-center justify-center p-2 md:p-10 overflow-hidden font-sans">
      <div className="w-full max-w-6xl h-[95vh] md:h-[90vh] flex flex-col gap-4">
        {/* PORTION 1: STATIC BACK BUTTON (No Scroll) */}
        ...
        <article className="flex-1 flex flex-col md:flex-row overflow-hidden rounded-[1.5rem] md:rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] border border-slate-300 bg-white">
          {/* PORTION 2: STATIC IMAGE PANEL (Fixed, No Stretch) */}
          {blog.thumbnail && (
            <div className="w-full md:w-[38%] h-48 md:h-full bg-black shrink-0 overflow-hidden">
              <img
                src={blog.thumbnail}
          ...
          <div className="flex-1 h-full bg-gradient-to-br from-[#064e3b] via-[#022c22] to-[#082f49] flex flex-col overflow-hidden">
            {/* PORTION 3: STATIC CONTENT HEADER (Title, Author, Meta - Fixed) */}
            <div className="p-6 md:p-12 pb-6 shrink-0 border-b border-white/5 bg-black/10 backdrop-blur-sm">
              <div className="flex justify-between items-center mb-4 md:mb-6">
                ...
                <div className="bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl backdrop-blur-md shadow-inner">
                  <p className="text-emerald-400 font-bold text-[9px] md:text-[10px] uppercase tracking-widest">
            ...
            {/* PORTION 4: SCROLLABLE BODY (Only this part moves) */}
            <div
